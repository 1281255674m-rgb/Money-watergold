  ...
  return (
    <>
      ...
      <div className="content-editor">
        <section className="editor-section"><div className="editor-section-head"><span>01</span><div><h2>品牌首屏</h2><p>控制首页最先看到的标题和说明。</p></div></div><div className="form-grid two-columns"><label className="field"><span>品牌名称</span><input value={content.brandName} onChange={(e) => setContent({ ...content, brandName: e.target.value })} /></label><label className="field"><span>宣传语</span><input value={content.slogan} onChange={(e) => setContent({ ...content, slogan: e.target.value })} /></label></div><label className="field"><span>首屏标签</span><input value={content.heroEyebrow} onChange={(e) => setContent({ ...content, heroEyebrow: e.target.value })} /></label><label className="field"><span>首屏介绍</span><textarea value={content.heroDescription} onChange={(e) => setContent({ ...content, heroDescription: e.target.value })} /></label><div className="form-grid two-columns"><label className="field"><span>招募标题</span><input value={content.recruitmentTitle} onChange={(e) => setContent({ ...content, recruitmentTitle: e.target.value })} /></label><label className="field"><span>公司页脚名称</span><input value={content.companyName} onChange={(e) => setContent({ ...content, companyName: e.target.value })} /></label></div><label className="field"><span>招募说明</span><textarea value={content.recruitmentDescription} onChange={(e) => setContent({ ...content, recruitmentDescription: e.target.value })} /></label></section>

        <section className="editor-section">
          <div className="editor-section-head"><span>02</span><div><h2>微信联系方式</h2><p>分别管理私人微信和企业微信，至少保留一种联系方式。</p></div></div>
